...
public class ModuleCompletionProposal implements ICompletionProposal,IJavaCompletionProposal {
	 ...
	 */
	public ModuleCompletionProposal(String replacementString, int replacementOffset, int replacementLength, int cursorPosition) {
	 ...
	 * @param type
	 */
	public ModuleCompletionProposal(String replacementString, int replacementOffset, int replacementLength, int cursorPosition,Image img,String type) {
	 ...
	 */
	public ModuleCompletionProposal(String replacementString, int replacementOffset, int replacementLength, int cursorPosition, Image image, String displayString, IContextInformation contextInformation, String additionalProposalInfo,String type) {
