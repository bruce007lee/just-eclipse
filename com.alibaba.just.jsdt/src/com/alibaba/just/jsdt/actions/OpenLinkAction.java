 ...
 *******************************************************************************/
package com.alibaba.just.jsdt.actions;
...
import com.alibaba.just.javascript.SearchEngine;
import com.alibaba.just.javascript.SearchResult;
 ...
 */
public class OpenLinkAction extends SelectionDispatchAction {
	 ...
	 */
	public OpenLinkAction(IWorkbenchSite site) {
		super(site);
	 ...
	 */
	public OpenLinkAction(JavaEditor editor,int offset,int length) {
	...
	public void run(ITextSelection selection) {
		...
		SearchResult rs =  SearchEngine.findReference(document.get(),this.offset,this.length);
		if(rs!=null){
			try{
				fEditor.getSelectionProvider().setSelection(new TextSelection(document,rs.getPosition(),rs.getLength()));
			}catch(Exception e){
